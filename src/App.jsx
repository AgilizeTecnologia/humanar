...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative bg-az-gradient text-white py-20 px-4 overflow-hidden">
        <div className="container mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in-up">
            Assédio Zero
          </h1>
          <p className="text-xl md:text-2xl mb-8 animate-fade-in-up opacity-90" style={{ animationDelay: '0.2s' }}>
            Plataforma de Denúncias Segura e Confidencial
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <Link
              to="/denuncias"
              className="btn-az-secondary hover-lift"
              onClick={handleDenunciaClick}
            >
              Fazer Denúncia
            </Link>
            <Link to="/atendimento" className="btn-az-primary hover-lift">
              Atendimento Online
            </Link>
            <Link to="/totem" className="btn-az-secondary hover-lift">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-az-gradient">
            Nossos Pilares
          </h2>
          <div className="grid md:grid-cols-3 gap-8 stagger-animation">
            <div className="card-modern p-8 text-center hover-lift">
              <Shield className="w-16 h-16 mx-auto mb-4 text-blue-600" />
              <h3 className="text-xl font-semibold mb-4">Registro de Denúncias</h3>
              <p className="text-gray-600">
                Registre sua denúncia de forma anônima ou identificada, com garantia de confidencialidade.
              </p>
            </div>
            <div className="card-modern p-8 text-center hover-lift">
              ...
              <p className="text-gray-600">
                Orientação para vítimas de assédio moral, sexual, trabalhista, religioso, institucional e virtual.
              </p>
            </div>
            <div className="card-modern p-8 text-center hover-lift">
              ...
              <p className="text-gray-600">
           Acesse a legislação sobre assédio e a estrutura de proteção para civis e militares.            </p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Stats Section */}
      <section className="py-16 px-4bg-az-gradient-subtle text-white">
        <div className="container mx-auto">
