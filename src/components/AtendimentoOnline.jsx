  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'bot',
      text: 'Olá! Bem-vindo ao canal de atendimento da plataforma Assédio Zero. Como posso ajudá-lo hoje?',
      timestamp: new Date(),
    },
  ]);
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6">
          ...
          <p className="text-blue-100">
            Use nosso assistente virtual para tirar dúvidas sobre o processo de denúncia.
          </p>
        </div>
