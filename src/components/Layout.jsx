          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center space-x-4">
              <div className="flex flex-col items-center">
                <div className="text-xs font-semibold text-gray-700 mb-1">Assédio Zero</div>
                <img
                  src="/logo-assedio-zero.png"
                  alt="Assédio Zero"
                  className="w-16 h-16 object-contain"
                />
                <div className="text-center mt-1">
                  <div className="text-[10px] font-medium text-gray-600">Assédio Zero</div>
                  <div className="text-[9px] text-gray-500">Plataforma de Denúncias de Assédio</div>
                </div>
              </div>
              <div className="hidden md:block">
                <h1 className="text-xl font-bold text-gray-800">Assédio Zero</h1>
                <p className="text-sm text-gray-600">Segurança e Confidencialidade</p>
              </div>
            </Link>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                ...
                Garantindo um ambiente de trabalho e social livre de assédio.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2025 Assédio Zero. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
