    ...
    <div className="text-center">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <h3 className="text-3xl font-semibold text-gray-800 mb-4">Registrar Denúncia de Assédio</h3>
          <p className="text-gray-600 text-lg">
            Registre sua denúncia de forma confidencial e segura
          </p>
        </button>
        ...
        >
          ...
          <h3 className="text-3xl font-semibold text-gray-800 mb-4">Informações Legais</h3>
          <p className="text-gray-600 text-lg">
            Acesse informações sobre assédio e legislação
          </p>
        </button>
  ...
  const renderDenunciaScreen = () => (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl p-12">
        <h2 className="text-4xl font-bold text-gray-800 mb-8">Registrar Denúncia de Assédio</h2>

        <div className="space-y-6">
          <div>
            <label className="block text-xl font-medium text-gray-700 mb-3">
              Tipo de Assédio/Denúncia
            </label>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl p-12">
        <h2 className="text-4xl font-bold text-gray-800 mb-8">
          Informações Legais sobre Assédio
        </h2>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-white opacity-90">Plataforma Assédio Zero</p>
              </div>
            </div>
          </div>
        </div>
